  ...
  return (
    <div className="py-[90px] md:py-[100px]">
      <div className={'container mx-auto'}>
        <h1 className="max-w-800 font-extrabold mx-auto text-center text-[28px] heading-[34px] md:text-[35px] md:heading-[42px] lg:text-[40px] lg:leading-[48px] lg:max-w-[70%] text-darkblue-800">
